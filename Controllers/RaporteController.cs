...
{
    public class RaporteController : Controller
    {
        private readonly ILogger<RaporteController> _logger;
        private MyContext _context;

        public RaporteController(ILogger<RaporteController> logger, MyContext context)
        {
            _logger = logger;
            _context = context;
        }
