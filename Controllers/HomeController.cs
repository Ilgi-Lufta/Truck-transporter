...
//        var Flete = await _context.FleteAnalizes.Where(e => e.model == true)
//            .Where(e => e.AdminId == admin)
//            .ToListAsync();
//        ViewBag.Flete = Flete;
...
//        var Flete = await _context.FleteAnalizes.Include(e => e.MyPacient)
//            .Include(e => e.mtms)
//            .ThenInclude(e => e.Myanaliz)
...
//        List<FleteAnalize> ilgi = await _context.FleteAnalizes.
//            Include(e => e.MyPacient)
//            .Where(e => e.AdminId == admin)
//            .Where(s => s.CreatedAt > searchFirstTime && s.CreatedAt < searchSecondTime/* && s.Pagesa == true*/)
//            .Where(e => e.model == false)
//            .ToListAsync();
//        ViewBag.Analiz = ilgi;
//        float Totali = 0;
